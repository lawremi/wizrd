...
parameterized_model |> chat(list(language = "R"))
```
...
equipped_model <- instructed_model |> equip(get_R_authors)
equipped_model |> chat(list(language = "R"))
```
...
s7_model <- equipped_model |> output_as(Person)
